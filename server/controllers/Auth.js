...
exports.signup = async (req, res) => {
  try {
    ...
    console.log("Received data:", { firstName, lastName, email, accountType, contactNumber });
    ...
    let approved = true; // Default to true for students
...
exports.sendotp = async (req, res) => {
  ...
  try {
    ...
    console.log("About to create OTP document...");
    
    // Create OTP document - the pre-save hook will automatically send the email
