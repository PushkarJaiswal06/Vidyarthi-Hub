...
exports.capturePayment = async (req, res) => {
  ...
  for (const course_id of courses) {
    ...
    try {
      ...
      console.log("Course found:", course ? course.courseName : "NOT FOUND");
      ...
      console.log("Course price:", course.price, "Total amount so far:", total_amount);
    } catch (error) {
