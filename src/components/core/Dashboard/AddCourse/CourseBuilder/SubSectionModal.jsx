    ...
    <div className="fixed inset-0 z-[1000] flex items-start justify-center bg-black/40 backdrop-blur-xl overflow-y-auto">
      <div className="rounded-2xl shadow-2xl border border-cyan-900/30 bg-gradient-to-br from-richblack-800/95 via-cyan-900/90 to-richblack-900/95 backdrop-blur-xl w-full max-w-2xl mx-auto mt-24 mb-10 pt-12 pb-10 text-white">
        ...
        <div className="flex items-center justify-between rounded-t-2xl px-8 py-6 border-b border-white/10 bg-white/10 backdrop-blur-xl">
          ...
          <button onClick={() => (!loading ? setModalData(null) : {})} className="text-2xl text-white/80 hover:text-white/100 transition-colors">
            <RxCross2 />
          </button>
        </div>
        {/* Modal Form */}
        ...
        >
          ...
          <div className="mb-6">
            <Upload
              ...
              className="glass-input border-2 border-dashed border-cyan-400/40 hover:border-cyan-400 transition-all bg-white/10 backdrop-blur-md rounded-xl p-6"
            />
          </div>
          {/* Lecture Title */}
          <div className="flex flex-col space-y-2">
            <label className="text-base font-semibold text-white/80 mb-1" htmlFor="lectureTitle">
            ...
            <input
              ...
              className="glass-input w-full text-white/90 placeholder-white/60"
            />
            {errors.lectureTitle && (
          ...
          {/* Lecture Description */}
          <div className="flex flex-col space-y-2">
            <label className="text-base font-semibold text-white/80 mb-1" htmlFor="lectureDesc">
            ...
            <textarea
              ...
              className="glass-input resize-none min-h-[130px] w-full text-white/90 placeholder-white/60"
            />
            {errors.lectureDesc && (
              <span className="ml-2 text-xs tracking-wide text-pink-200">
