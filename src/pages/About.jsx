  ...
  return (
    <div>
        ...
        <div className="relative mx-auto flex w-11/12 max-w-maxContent flex-col justify-between gap-10 text-center text-white">
          <header className="mx-auto py-20 text-4xl font-semibold lg:w-[70%]">
            ...
            <p className="mx-auto mt-3 text-center text-base font-medium text-richblack-300 lg:w-[95%]">
              VidyarthiHub is at the forefront of driving innovation in online
              education. We are passionate about transforming the way people learn
              and empowering individuals to achieve their goals through accessible,
      ...
      <section className="mx-auto mt-20 flex w-11/12 max-w-maxContent flex-col justify-between gap-10 text-white">
        <LearningGrid />
        {/* Portfolio + Get in Touch Section */}
        <div className="flex flex-col lg:flex-row gap-10 mt-10">
          {/* Portfolio Card */}
          <div className="lg:w-[48%] w-full flex justify-center">
            <div className="flex flex-col items-center gap-4 p-6 rounded-xl bg-richblack-800 w-full max-w-md">
